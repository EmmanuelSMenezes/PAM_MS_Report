...
MicroserviÃ§o para **geraÃ§Ã£o de relatÃ³rios e analytics**. Produz dashboards interativos, mÃ©tricas de performance, relatÃ³rios financeiros, anÃ¡lises de dados da plataforma, KPIs, exportaÃ§Ã£o em mÃºltiplos formatos e business intelligence.

### ðŸŽ¯ Principais Funcionalidades

- ðŸ“Š **Dashboards**: PainÃ©is interativos
- ðŸ“ˆ **KPIs**: Indicadores de performance
- ðŸ’° **Financeiro**: RelatÃ³rios de receita
- ðŸ“‹ **Operacional**: MÃ©tricas de operaÃ§Ã£o
- ðŸ“Š **Analytics**: Business Intelligence
- ðŸ“„ **ExportaÃ§Ã£o**: PDF, Excel, CSV
- ðŸŽ¯ **CustomizaÃ§Ã£o**: RelatÃ³rios personalizados
- â° **Agendamento**: RelatÃ³rios automÃ¡ticos
...
{
  "ConnectionStrings": {
    "DefaultConnection": "Server=localhost;Database=PAM_PAM_MS_Report;Trusted_Connection=true;MultipleActiveResultSets=true"
  }
}
`
...
`ash
# Build da imagem
docker build -t PAM_MS_Report.ToLower() .
...
- **Local**: http://localhost:5009/swagger
- **ProduÃ§Ã£o**: https://api.pam.com/PAM_MS_Report.ToLower()/swagger
...
curl -X GET "http://localhost:5009/api/v1/..." \
...
az webapp deploy --resource-group PAM --name PAM_MS_Report --src-path ./publish
`
...
`ash
# Tag da imagem
docker tag PAM_MS_Report.ToLower() registry.azurecr.io/pam/PAM_MS_Report.ToLower():latest

# Push para registry
docker push registry.azurecr.io/pam/PAM_MS_Report.ToLower():latest
`
...
- **ðŸ› Issues**: [GitHub Issues](https://github.com/EmmanuelSMenezes/PAM_MS_Report/issues)
- **ðŸ“– Wiki**: [DocumentaÃ§Ã£o Completa](https://github.com/EmmanuelSMenezes/PAM_MS_Report/wiki)
...
**[â¬† Voltar ao Topo](#-PAM_MS_Report)**
