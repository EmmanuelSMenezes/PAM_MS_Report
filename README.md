...
MicroserviÃ§o para geraÃ§Ã£o de relatÃ³rios e analytics. Produz dashboards, mÃ©tricas de performance, relatÃ³rios financeiros e anÃ¡lises de dados da plataforma.
...
2. **Execute o container**
   `ash
   docker run -p 5009:5009 -e ConnectionStrings__DefaultConnection="sua-connection-string" PAM_MS_Report.ToLower()
   `

## ðŸ“š DocumentaÃ§Ã£o da API

A documentaÃ§Ã£o completa da API estÃ¡ disponÃ­vel via Swagger UI:
- **Desenvolvimento**: http://localhost:5009/swagger
