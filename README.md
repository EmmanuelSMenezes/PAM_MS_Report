...
Microserviço para **geração de relatórios e analytics**. Produz dashboards interativos, métricas de performance, relatórios financeiros, análises de dados da plataforma, KPIs, exportação em múltiplos formatos e business intelligence.
...
- 📋 **Operacional**: Métricas de operação
...
- **Produção**: `https://api.pam.com/pam_ms_report/swagger`
...
- **📖 Wiki**: [Documentação Completa](https://github.com/EmmanuelSMenezes/PAM_MS_Report/wiki)
